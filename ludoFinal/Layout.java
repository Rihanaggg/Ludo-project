...
// class that draws board
 class Layout {
	...
	public void draw(Graphics2D g){
        ...
        for(int i=1;i<6;i++) { // drawing the path
        	g.setColor(Color.RED);
    	...
    	for(int i=0;i<2;i++) { // Drawing the house rectangle
    		for(int j=0;j<2;j++) {
    			g.setColor(Color.RED);
		...
		// Drawing the triangles houses in the center
    	g.setColor(Color.RED);
    	...
    	for(int i=0;i<3;i++) { // Drawing the path outline
    		for(int j=0;j<6;j++) {
		...
		// Drawing the circles in the center
